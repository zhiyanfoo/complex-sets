...
/* package complex-sets-0.1.0.0 */
#define VERSION_complex_sets "0.1.0.0"
#define MIN_VERSION_complex_sets(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "complex-sets-0.1.0.0"

#define CURRENT_PACKAGE_KEY "complex-sets-0.1.0.0"
